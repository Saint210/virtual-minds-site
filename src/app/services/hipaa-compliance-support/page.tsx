...
// title: "HIPAA Compliant Virtual Assistants & Psychiatric Compliance | California"
                    ...
                    <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                            ...
                            <div className="lg:w-[60%]">
                                <motion.div {...fadeUp(0)} className="inline-flex items-center gap-2 bg-white border border-[#1A2332]/10 rounded-full px-5 py-2 text-trust-navy text-xs font-black mb-4 shadow-sm">
                                ...
                                <motion.h1 {...fadeUp(0.08)} className="font-display text-4xl md:text-6xl lg:text-[4.5rem] font-bold text-trust-navy mb-5 leading-[0.95] tracking-tight">
                                    HIPAA Compliant <br />
                                ...
                                <motion.p {...fadeUp(0.16)} className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed font-light">
                                    We don&apos;t just &ldquo;follow&rdquo; HIPAA&mdash;we deploy
                                    <span className="text-trust-navy font-bold border-b-2 border-[#D2691E]/30 mx-2">Business Associate Agreements (BAA)</span>
                                    and secure workspaces that protect your license and patient trust.
                                </motion.p>
                    ...
                    <section className="max-w-[1280px] mx-auto px-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                            {[
                                ...
                                <motion.div key={i} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6, delay: i * 0.08, ease: "easeOut" as const }} className="flex flex-col gap-6 p-10 bg-white rounded-[2.5rem] border border-slate-100 hover:shadow-2xl hover:shadow-[#D2691E]/10 transition-all duration-500 group">
