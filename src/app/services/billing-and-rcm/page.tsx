                    ...
                    <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            ...
                            <div className="lg:w-1/2">
                                <motion.div {...fadeUp(0)} className="inline-flex items-center gap-2 bg-trust-navy/5 border border-trust-navy/10 rounded-full px-4 py-1.5 text-trust-navy text-[11px] font-black uppercase tracking-widest mb-4">
                                    <span className="material-symbols-outlined text-sm">verified</span>
                                    Verified Liaison Service
                                </motion.div>
                                <motion.h1 {...fadeUp(0.08)} className="font-serif text-4xl md:text-6xl font-bold text-trust-navy mb-4 leading-[1.1] tracking-tight">
                                ...
                                <motion.p {...fadeUp(0.16)} className="text-lg md:text-xl text-slate-600 font-medium leading-relaxed mb-6 max-w-2xl">
                                ...
                                <motion.div {...fadeUp(0.28)} className="flex flex-col sm:flex-row gap-4 mb-8">
                                    <TrackedLink
                            ...
                            {/* Visual */}
                            <motion.div {...fadeUp(0.18)} className="lg:w-1/2 relative w-full">
                ...
                <section id="scope" className="py-24 bg-white border-y border-slate-100">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6 }} className="bg-slate-50 rounded-[2.5rem] p-10 border border-emerald-100 shadow-xl shadow-emerald-900/5 relative overflow-hidden group">
                            ...
                            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6 }} className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm relative overflow-hidden opacity-80 hover:opacity-100 transition-opacity">
                    ...
                    <div className="max-w-[1280px] mx-auto px-6">
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                <motion.div key={i} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6, delay: i * 0.12 }} className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:border-trust-navy transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group">
