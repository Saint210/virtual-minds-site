...
// Note: metadata export removed – must live in a server component (layout).
                    ...
                    <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            ...
                            <div className="lg:w-1/2">
                                <motion.div {...fadeUp(0)} className="inline-flex items-center gap-2 bg-white border border-primary/20 rounded-full px-4 py-1.5 text-trust-navy text-[11px] font-black uppercase tracking-widest mb-4 shadow-sm">
                                    <span className="material-symbols-outlined text-primary text-sm">psychology</span>
                                    High-Acuity Operations
                                </motion.div>
                                <motion.h1 {...fadeUp(0.08)} className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-trust-navy mb-4 leading-[1.1]">
                                    Not a "Virtual Assistant."<br />
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
                                        Clinical Operations Support.
                                    </span>
                                </motion.h1>
                                <motion.p {...fadeUp(0.16)} className="text-xl text-slate-600 font-medium leading-relaxed mb-6 max-w-2xl">
                            ...
                            {/* Visual */}
                            <motion.div {...fadeUp(0.18)} className="lg:w-1/2 relative">
                ...
                <section id="capabilities" className="py-24 bg-white border-y border-slate-100">
                    <div className="max-w-[1280px] mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6, delay: 0 }} className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-200 hover:border-trust-navy transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group relative overflow-hidden">
                            ...
                            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6, delay: 0.12 }} className="bg-white p-8 rounded-[2.5rem] border-2 border-primary/20 shadow-xl relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
                                {/* Technical Grid Background */}
                            ...
                            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6, delay: 0.24 }} className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-200 hover:border-trust-navy transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group relative overflow-hidden">
                                {/* Technical Grid Background */}
                                <div className="absolute inset-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[size:24px_24px] opacity-40" />
