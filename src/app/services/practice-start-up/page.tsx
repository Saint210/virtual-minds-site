                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            ...
                            <div className="lg:w-1/2">
                                ...
                                <motion.p {...fadeUp(0.16)} className="text-xl text-slate-600 font-medium leading-relaxed mb-6 max-w-2xl">
                                    Don&apos;t waste 6 months Googling &ldquo;how to start a Psychiatric Private Practice in California.&rdquo; We deploy a turnkey <span className="text-trust-navy font-bold">operational setup</span>—EHR, credentialing, and compliance—so you open your doors in 30 days.
                                </motion.p>
                ...
                <section id="roadmap" className="py-24 bg-white border-y border-slate-100">
                    <div className="max-w-[1280px] mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            {/* OPERATIONAL SETUP */}
                            <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-60px" }} transition={{ duration: 0.6 }} className="bg-[#FAF8F3] rounded-[2rem] p-10 border border-slate-200">
