                ...
                <section className="py-24 bg-white border-t border-slate-100 relative">
                    ...
                    <div className="max-w-[1400px] mx-auto px-6">
                        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                            <div>
                                <span className="text-primary font-bold tracking-widest uppercase text-xs mb-3 block">System Modules</span>
                                <h2 className="font-serif text-4xl text-trust-navy leading-tight">Operational <span className="italic text-slate-400">Capabilities</span></h2>
                            </div>
                            <p className="text-slate-500 max-w-sm text-sm font-medium leading-relaxed">
                                Modular administrative support designed to integrate with high-complexity psychiatric workflows.
                            </p>
                        </div>
