...
// Note: metadata removed — must live in a server component (layout).
                    ...
                    <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                            ...
                            <div className="lg:w-[60%]">
                                <motion.div {...fadeUp(0)} className="inline-flex items-center gap-2 bg-white border border-primary/20 rounded-full px-5 py-2 text-trust-navy text-xs font-black mb-4 shadow-sm">
                                ...
                                <motion.p {...fadeUp(0.16)} className="text-lg md:text-xl text-slate-600 font-display leading-relaxed mb-6 max-w-2xl">
                                    We build the
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid gap-6">
                                    {[
                                        ...
                                        <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-40px" }} transition={{ duration: 0.5, delay: i * 0.06, ease: "easeOut" as const }} className="flex items-start gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:border-trust-navy hover:shadow-lg transition-all group">
