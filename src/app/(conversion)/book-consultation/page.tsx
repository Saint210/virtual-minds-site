                ...
                <div className="max-w-[1300px] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                    ...
                    <div className="flex flex-col gap-8">
                        <div className="flex flex-col gap-5">
                            ...
                            <motion.h1 {...fadeUp(0.1)} className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-trust-navy leading-tight tracking-tight">
                            ...
                            <motion.p {...fadeUp(0.18)} className="text-base md:text-lg text-slate-600 leading-relaxed">
                        ...
                        <div className="bg-white/50 backdrop-blur-sm border border-slate-200 rounded-[32px] p-8 md:p-10 shadow-xl">
                            ...
                            <div className="space-y-10">
                                {/* Step 1 */}
                                <motion.div initial={{ opacity: 0, x: -16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0, ease: "easeOut" as const }} className="flex gap-6 group">
                                ...
                                {/* Step 2 */}
                                <motion.div initial={{ opacity: 0, x: -16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1, ease: "easeOut" as const }} className="flex gap-6 group">
                                    <div className="flex flex-col items-center">
                                ...
                                {/* Step 3 */}
                                <motion.div initial={{ opacity: 0, x: -16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2, ease: "easeOut" as const }} className="flex gap-6 group">
                                    <div className="flex flex-col items-center">
