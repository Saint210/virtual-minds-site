...
export const locations: LocationData[] = [
    {
        slug: "los-angeles",
        name: "Los Angeles",
        metaTitle: "Los Angeles Psychiatric Virtual Assistant | Mental Health Admin",
        metaDesc: "Elite Psychiatric Virtual Assistants for Los Angeles private practices. specialized in DrChrono, HIPAA compliance, and telepsychiatry workflows in Beverly Hills & Santa Monica.",
        rentAvg: "$4.50/sqft",
    ...
    },
    {
        slug: "san-francisco",
        name: "San Francisco",
        metaTitle: "San Francisco Psychiatric Virtual Assistant | Telehealth Admin",
        metaDesc: "San Francisco Psychiatric Virtual Assistants for UCSF affiliates and private practices. Expert management of intake, billing, and EHR for Bay Area mental health professionals.",
        rentAvg: "$6.50/sqft",
    ...
    },
    {
        slug: "san-diego",
        name: "San Diego",
        metaTitle: "San Diego Psychiatric Virtual Assistant | Private Practice Support",
        metaDesc: "San Diego Psychiatric Virtual Assistants for La Jolla & Del Mar clinicians. HIPAA-compliant intake coordination and billing support for UCSD Health network providers.",
        rentAvg: "$3.80/sqft",
    ...
    },
    {
        slug: "beverly-hills",
        name: "Beverly Hills",
        metaTitle: "Beverly Hills Psychiatric Virtual Assistant | Concierge Mental Health",
        metaDesc: "Premium Psychiatric Virtual Assistants for Beverly Hills concierge practices. Discrete, high-touch patient coordination for 90210 mental health professionals.",
        rentAvg: "$7.20/sqft",
    ...
    },
    {
        slug: "palo-alto",
        name: "Palo Alto",
        metaTitle: "Palo Alto Psychiatric Virtual Assistant | Stanford Area Admin",
        metaDesc: "Palo Alto Psychiatric Virtual Assistants for Stanford-affiliated clinicians. Streamline your Silicon Valley mental health practice with expert remote staffing.",
        rentAvg: "$8.00/sqft",
    ...
    },
    {
        slug: "newport-beach",
        name: "Newport Beach",
        metaTitle: "Newport Beach Psychiatric Virtual Assistant | Orange County Mental Health",
        metaDesc: "Newport Beach Psychiatric Virtual Assistants for coastal private practices. HIPAA-compliant intake and billing support for mental health professionals in Fashion Island & Newport Coast.",
        rentAvg: "$5.00/sqft",
