                    ...
                    <div className="flex flex-col gap-8 text-center lg:text-left">
                        ...
                        <div className="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0">
                            ...
                            <div className="bg-[#DAA520]/10 border border-[#DAA520]/20 rounded-xl p-4 hover:bg-[#DAA520]/20 transition-all">
                                ...
                                <div className="text-[#4A4A4A] text-xs font-medium">CA Practices</div>
                            </div>
                        </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-6 -right-6 bg-white border-2 border-[#D2691E]/20 rounded-xl p-6 shadow-xl max-w-[200px] hover:bg-[#D2691E]/5 transition-all">
                            <div className="text-center">
                                ...
                                <p className="text-xs font-bold uppercase tracking-widest text-[#4A4A4A]">Avg ROI</p>
                                <p className="text-xs text-[#4A4A4A] mt-1">Most practices</p>
                            </div>
                        </div>
                        ...
                        <div className="absolute bottom-6 -left-6 bg-[#DAA520]/10 border border-[#DAA520]/20 rounded-xl p-4 shadow-xl hover:bg-[#DAA520]/20 transition-all">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="text-xs font-bold text-[#4A4A4A]">EHR</p>
                                    <p className="text-xs text-[#4A4A4A]">Experts</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#9CAF88]/5 border border-[#9CAF88]/10 rounded-2xl p-8 text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
                            ...
                            <div className="bg-[#FAF8F3] border border-[#DAA520]/20 rounded-xl p-6 hover:bg-[#DAA520]/5 transition-all">
                                ...
                                <p className="text-sm font-semibold text-[#4A4A4A]">More Patients</p>
                            </div>
                            <div className="bg-[#FAF8F3] border border-[#4A4A4A]/20 rounded-xl p-6 hover:bg-[#4A4A4A]/5 transition-all">
                                <p className="text-3xl md:text-4xl font-black text-[#4A4A4A] mb-2">50+</p>
                                <p className="text-sm font-semibold text-[#4A4A4A]">Practices Served</p>
                            </div>
                        </div>
                    </div>
                </div>
