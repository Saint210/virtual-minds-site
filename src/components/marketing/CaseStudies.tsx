...
export default function CaseStudies() {
    const cases = [
        {
            title: "Beverly Hills Psychiatry Group",
            location: "Los Angeles, CA",
            metric: "40% Reduction",
            description: "Admin time saved while maintaining confidentiality for high-profile patients",
            timeframe: "3 months",
        ...
        {
            title: "Silicon Valley Mental Health",
        ...
        {
            title: "San Diego Young Adult Practice",
            location: "San Diego, CA",
            metric: "25% Growth",
            description: "Patient capacity increased without adding staff",
            timeframe: "4 months",
